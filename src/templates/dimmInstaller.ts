...
export const dimmInstallerTemplate: Template = {
  ...
  params: [
    ...
    { kind: "number", key: "handleChamfer", label: "握把頂邊斜切量(逼近 R3 圓角)", min: 0, max: 8, step: 0.1, default: 3, unit: "mm", group: "進階細節" },
    ...
    { kind: "number", key: "centerClearanceDepth", label: "中央鏤空深度(晶片安全淨空)", min: 2, max: 10, step: 0.1, default: 4, unit: "mm", group: "進階細節" },
    { kind: "number", key: "endCapDepth", label: "端蓋下沉深度(防滑)", min: 0, max: 15, step: 0.5, default: 6, unit: "mm", group: "進階細節" },
    { kind: "number", key: "endCapThickness", label: "端蓋厚度", min: 1, max: 8, step: 0.5, default: 3, unit: "mm", group: "進階細節" },
  ],
  build: (values, M) => {
